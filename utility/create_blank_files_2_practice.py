...
Subdomain : None
Domain    : None
Author    : Ahmedur Rahman Shovon --> Copied from his github
https://github.com/arsho/Hackerrank_Python_Domain_Solutions/blob/master/HackerrankUtility/Hackerrank_Solution_Blank_File_Creator.py
